$(document).ready(function () {
  buscaProcessador();
  editaExcluiProcessador();
});

//Função do campo de busca
function buscaProcessador() {
  $('#buscaProcessador').on('keyup', function () {
...
function editaExcluiProcessador() {
  ...
  $('.btn-excluir').on('click', function (event) {
    ...
    Swal.fire({
      title: 'Tem certeza?',
      text:
        'Você está prestes a excluir este Processador. Esta ação não pode ser desfeita.',
      icon: 'warning',
