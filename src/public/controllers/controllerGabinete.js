...
function buscaGabinete() {
  $('#buscaGabinete').on('keyup', function () {
...
function editaExcluiGabinete() {
  ...
  $('.btn-excluir').on('click', function (event) {
    ...
    Swal.fire({
      title: 'Tem certeza?',
      text:
        'Você está prestes a excluir este gabinete. Esta ação não pode ser desfeita.',
      icon: 'warning',
